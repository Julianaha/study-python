...
create user julianasouza with password 'luizacode123';

grant all privileges on database luizacode to julianasouza;

SELECT * FROM pg_catalog.pg_user;

/* DCL - Add/Modify data */
insert into users (email, password)
	values ('julianasouza', 123);

insert into users (email, password, is_admin)
	values ('julianaha01@gmail.com', 12345, true);
	
/* Visualizacao da tabela users */
select * from users;
